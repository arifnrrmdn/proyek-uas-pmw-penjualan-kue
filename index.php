...
<body>
  ...
  <div class="sidebar">
    <a ><h2 style="color: white;">Lacchoco</h2></a>
    <a href="#">Dashboard</a>
      ...
      <tbody>
        <?php
          ...
          foreach ($result as $data){
            $angka_harga = $data["harga"];
            $harga = "Rp " . number_format($angka_harga,0,',','.');
          
            $angka_total_harga = $data["total_harga"];
            $total_harga = "Rp " . number_format($angka_total_harga,0,',','.');
